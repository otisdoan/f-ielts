    ...
    <header className="sticky top-0 z-50 w-full border-b border-solid border-[#e6dbdb] -[#3d2a2a] bg-white/80 -background-dark/80 backdrop-blur-md">
      <div className="max-w-[1280px] mx-auto px-6 lg:px-10 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link href="/login">
            <button className="flex min-w-[84px] cursor-pointer items-center justify-center rounded-lg h-10 px-6 bg-primary text-white text-sm font-bold shadow-lg shadow-primary/20 hover:bg-red-600 transition-all active:scale-95">
              Login
            </button>
          </Link>
        </div>
