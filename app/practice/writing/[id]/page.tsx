...
export default function WritingPracticeInterface() {
  ...
  const handleFinishLater = () => {
    if (content && confirm("Do you want to save your progress before leaving?")) {
      handleSaveDraft();
    }
       ...
       return (
        <div className="min-h-screen flex items-center justify-center bg-background-light">
          <div className="text-center">
            ...
            <Link href="/practice/writing" className="mt-4 inline-block text-primary hover:underline">
        ...
        <div className="flex items-center gap-6 md:gap-10">
          ...
          <div className="flex gap-2 items-center bg-slate-100 px-3 md:px-4 py-1.5 rounded-lg border border-slate-200">
            ...
            <div className="flex gap-1.5">
              <p className="text-[#181111] text-sm font-bold font-mono">{time.hours}</p>
              <span className="text-[#181111] text-sm font-bold">:</span>
              <p className="text-[#181111] text-sm font-bold font-mono">{time.minutes}</p>
              <span className="text-[#181111] text-sm font-bold">:</span>
              <p className="text-[#181111] text-sm font-bold font-mono">{time.seconds}</p>
            </div>
          </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg border border-blue-100">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>You should spend about {prompt.task_type === 'task1' ? '20' : '40'} minutes on this task.</li>
                    <li>{prompt.task_type === 'task1' 
              ...
              <div className="flex items-center gap-6">
                <div className="flex flex-col">
                  ...
                  <span className="text-xl font-bold text-[#181111]">
                    {wordCount}
                    <span className={`text-sm font-normal ${wordCount >= minWordCount ? 'text-green-600' : 'text-slate-400'}`}>
                      {' '}/ {minWordCount} min
                    </span>
                  </span>
                </div>
