...
export default function WritingPracticePage() {
  ...
  const startRandomPrompt = (taskPrompts: WritingPrompt[]) => {
    ...
    const randomPrompt =
      taskPrompts[Math.floor(Math.random() * taskPrompts.length)];
  ...
  const categories = [
    ...
    },
    {
      ...
      title: "Task 2",
      description:
        "Write a formal essay in response to a point of view, argument or problem.",
      time: "40 mins",
      icon: "edit_document",
                ...
                {categories.map((category) => (
                  ...
                  >
                    <div className="flex items-start gap-4 mb-4">
                      <div
                        className={`size-14 rounded-xl ${category.bg} ${category.color} flex items-center justify-center shrink-0`}
                      >
                      ...
                      <div className="flex-1">
                        <h2 className="text-xl font-bold text-[#181111] mb-1">
                          {category.title}
                        </h2>
                        <p className="text-[#896161] text-sm font-medium">
                          {category.time}
                        </p>
                      </div>
                    </div>
