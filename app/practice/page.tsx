...
export default function PracticePage() {
  return (
    <div className="bg-background-light dark:bg-background-dark font-display min-h-screen font-sans">
      <DashboardHeader />
      <main className="max-w-[1200px] mx-auto px-4 md:px-10 lg:px-40 py-10">
        ...
        <div className="flex flex-wrap justify-between items-end gap-3 pb-8">
          <div className="flex min-w-72 flex-col gap-1">
            <p className="text-[#181111] dark:text-white text-4xl font-black leading-tight tracking-[-0.033em]">
              Master Your Skills
            </p>
            <p className="text-[#896161] dark:text-white/60 text-lg font-normal leading-normal">
              Select an IELTS module to begin your targeted practice session.
            </p>
          </div>
          <div className="flex items-center gap-2 bg-white dark:bg-white/5 px-4 py-2 rounded-xl border border-[#e6dbdb] dark:border-white/10">
            <span className="material-symbols-outlined text-primary text-sm">
              event
            </span>
            <span className="text-sm font-medium text-[#181111] dark:text-white/80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-12">
          {/* Reading Card */}
          <div className="group flex flex-col gap-6 rounded-xl border border-[#e6dbdb] dark:border-white/10 bg-white dark:bg-[#2d1a1a] p-6 shadow-sm hover:shadow-md transition-all hover:-translate-y-1">
            <div className="flex justify-between items-start">
              ...
              <div className="relative flex items-center justify-center">
                <svg className="size-16">
                  <circle
                    className="text-[#f4f0f0] dark:text-white/5"
                    cx="32"
                    cy="32"
                    fill="transparent"
                    r="28"
                ...
                <span className="absolute text-xs font-bold text-[#181111] dark:text-white">
                  75%
                </span>
              </div>
            </div>
            <div className="flex flex-col gap-2">
              <h2 className="text-[#181111] dark:text-white text-2xl font-bold leading-tight">
                Reading
              </h2>
              <p className="text-[#896161] dark:text-white/60 text-base leading-normal">
                Enhance comprehension with academic passages and question-type
                drills.
              </p>
            </div>
            <div className="flex items-center justify-between mt-auto">
              <span className="text-xs font-semibold text-[#896161] dark:text-white/40 uppercase tracking-wider">
                15/20 Lessons
              </span>
        ...
        <div className="bg-white dark:bg-[#2d1a1a] rounded-xl border border-[#e6dbdb] dark:border-white/10 p-8">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-[#181111] dark:text-white text-xl font-bold">
              Recommended for you
            </h3>
          ...
          <div className="flex flex-wrap gap-4">
            <div className="flex-1 min-w-[300px] flex items-center gap-4 p-4 rounded-lg bg-background-light dark:bg-white/5 border border-transparent hover:border-primary/20 transition-all cursor-pointer">
              <div className="size-12 rounded-lg bg-orange-100 text-orange-600 flex items-center justify-center">
                <span className="material-symbols-outlined">trending_up</span>
              </div>
              <div>
                <p className="text-[#181111] dark:text-white font-bold">
                  Vocabulary Drill: Environment
                </p>
                <p className="text-[#896161] dark:text-white/60 text-sm">
      ...
      <footer className="mt-auto border-t border-[#e6dbdb] dark:border-white/10 py-10 px-4 md:px-10 lg:px-40 opacity-60">
