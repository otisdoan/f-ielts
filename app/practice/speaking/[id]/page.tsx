    ...
    <div className="min-h-screen bg-background-light dark:bg-background-dark flex flex-col">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-solid border-[#e6dbdb] bg-white dark:bg-background-dark/90 backdrop-blur px-4 md:px-10 lg:px-40 py-3">
        <div className="flex items-center justify-between max-w-[1200px] mx-auto">
          ...
          <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 ring-2 ring-primary/20" style={{backgroundImage: 'url("https://cdn.usegalileo.ai/sdxl10/3f3e1a8c-6197-4ea8-8533-5c3e23daa3d6.png")'}}></div>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 flex flex-col gap-8">
            ...
            <div className="flex flex-col items-center gap-8 py-8">
              ...
              {/* Recording Button */}
              <button
                onClick={phase === "recording" || isRecording ? stopRecording : startRecording}
