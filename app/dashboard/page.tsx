    ...
    <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 min-h-screen font-sans">
      ...
      <main className="max-w-[1280px] mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm border-l-4 border-l-primary">
            <div className="flex justify-between items-start mb-4">
              <div className="p-2 bg-red-50 dark:bg-primary/10 rounded-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {/* Reading */}
                <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 flex flex-col gap-4">
            ...
            <section>
              <div className="flex items-center justify-between mb-4 px-2">
                ...
                <div className="flex gap-2">
                  <button className="text-xs font-bold px-3 py-1 bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 cursor-pointer hover:bg-slate-50">
                    1W
                  </button>
              ...
              <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 min-h-[300px] flex flex-col items-center justify-center text-center relative overflow-hidden">
          ...
          <div className="space-y-8">
            {/* Recent Activity */}
            <section>
              <h2 className="text-slate-900 dark:text-white text-xl font-bold mb-4 px-2">
                Recent Activity
              </h2>
              <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                <div className="divide-y divide-slate-100 dark:divide-slate-800">
                  <div className="p-4 flex gap-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                    <div className="w-10 h-10 shrink-0 rounded-full bg-emerald-50 dark:bg-emerald-900/20 flex items-center justify-center">
                  ...
                  <div className="p-4 flex gap-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                    <div className="w-10 h-10 shrink-0 rounded-full bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center">
                      <span className="material-symbols-outlined text-blue-600">
                        visibility
                      </span>
                    </div>
                  ...
                  <div className="p-4 flex gap-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                    <div className="w-10 h-10 shrink-0 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center">
                ...
                <button className="w-full p-4 text-xs font-bold text-slate-500 hover:text-primary transition-colors bg-slate-50/50 dark:bg-slate-800/30 cursor-pointer">
                  View All History
                </button>
              </div>
            </section>
            {/* Recommendation Card */}
            <section>
              <div className="bg-slate-900 dark:bg-primary/10 rounded-2xl p-6 text-white dark:text-primary border border-slate-800 dark:border-primary/20 relative overflow-hidden">
                ...
                <button className="w-full bg-white dark:bg-primary text-slate-900 dark:text-white font-bold py-3 rounded-xl text-sm hover:scale-[1.02] transition-transform cursor-pointer">
                  Start Lesson
                </button>
              </div>
            </section>
      ...
      <footer className="max-w-[1280px] mx-auto py-12 px-4 border-t border-slate-200 dark:border-slate-800 mt-12 flex flex-col md:flex-row justify-between items-center gap-6 opacity-60">
