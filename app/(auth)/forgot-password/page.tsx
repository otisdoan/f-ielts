...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-slate-200 -slate-800 p-8">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-slate-900 -white">Reset Password</h2>
      ...
      {!submitted ? (
        ...
        <div className="text-center space-y-6">
          <div className="w-16 h-16 bg-green-100 -green-900/30 text-green-600 rounded-full flex items-center justify-center mx-auto">
            <span className="material-symbols-outlined text-3xl">mark_email_read</span>
          </div>
          <div>
            <p className="text-slate-900 -white font-semibold">Check your email</p>
