...
export default function AddSpeakingPromptPage() {
  ...
  const handlePartChange = (part: SpeakingPart) => {
    // Adjust default times based on part
    let prepTime = 0;
    let speakTime = 120;
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-slate-600">Create a new IELTS speaking practice prompt</p>
      </div>
